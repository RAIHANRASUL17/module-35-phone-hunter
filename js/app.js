...
//     });
//      /*-------------- stop loader  ---------------------*/ 
//     // stop loader: call function toggleLoader
//     toggleLoader(false);
//     /*----------------------------------------------------------*/
// };
...
// document.getElementById('btn-search').addEventListener('click', function () {
//     /*-------------- start loader  ---------------------*/ 
//     // start loader: call function toggleLoader
//     toggleLoader(true);
//     /*----------------------------------------------------------*/ 
//     const searchField = document.getElementById('search-field');
//     const searchValue = searchField.value;
...
//  /*_________________________ toggle-Loader part _________________________________*/
//  const toggleLoader = isLodding => {
// const toggleLoaderSection= document.getElementById('toggle-Loader');
// if(isLodding){
//     toggleLoaderSection.classList.remove('d-none')
// }
// else{
//     toggleLoaderSection.classList.add('d-none')
// }
...
/*__________________________ step-6 ___________________________*/
const loadPhones = async (searchValue) => {
    const url = ` https://openapi.programming-hero.com/api/phones?search=${searchValue} `
    const res = await fetch(url);
    const data = await res.json();
